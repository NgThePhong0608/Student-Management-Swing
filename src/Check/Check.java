...
public class Check {
    ...
    public static boolean checkMark(String n) {
        if (n == null || n.length() > 3 || n.length() < 1 || Float.parseFloat(n) > 10 || Float.parseFloat(n) < 0) {
            ...
            return true;
        } else if (n.length() > 1 && !n.substring(1, 2).equals(".")) {
            return false;
        } else
            return true;
    }
    ...
    public static boolean checkDate(String n) {
        if (n == null || n.length() < 10 || Integer.parseInt(n.substring(0, 2)) > 31
                || Integer.parseInt(n.substring(3, 5)) > 12 || Integer.parseInt(n.substring(6, 10)) < 1900
                || Integer.parseInt(n.substring(6, 10)) > 3000) {
            /*
             * ||Integer.parseInt(n.substring(0,2))>31||Integer.parseInt(n.substring(3,5))>
             * 12||Integer.parseInt(n.substring(6,10))<1900||Integer.parseInt(n.substring(6,
             * 10))>3000
             */
            return false;
        } else {
