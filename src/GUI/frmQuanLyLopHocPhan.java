...
public class frmQuanLyLopHocPhan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jdNgayThi = new javax.swing.JTextField();
        ...
        menuThu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6" }));
    ...
    private void jbNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNewActionPerformed
        ...
        String ngayThi = jdNgayThi.getText();
        Check c = new Check();
        if (!checkinfo()) {
            return;
        } else if (Integer.parseInt(siSo) < 40 || Integer.parseInt(siSo) > 80) {
    ...
    public boolean checkinfo() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getPhongHoc().equals(txtPhongHoc.getText()) && list.get(i).getTietHoc().equals(menuTietHoc.getSelectedItem())
                ...
                txtMaLHP.requestFocus();
                return false;
            } else if (!c.checkMaLHP(txtMaLHP.getText())) {
                ...
                return false;
            } else if (!c.checkSpace(txtMaHP.getText()) || !c.checkIDHP(txtMaHP.getText())) {
            ...
            } else if ((jdNgayThi.getText().equals("") == true)) {
                JOptionPane.showMessageDialog(this, "Ngày thi không được trống ! Vui lòng chọn ngày thi", "Thông báo", JOptionPane.ERROR_MESSAGE);
                return false;
            } else if (Integer.parseInt((jdNgayThi.getText().substring(6, 10))) < Integer.parseInt(MainAdmin.date.substring(6, 10))) {
                ...
                return false;
            } else if (Integer.parseInt((jdNgayThi.getText().substring(6, 10))) == Integer.parseInt(MainAdmin.date.substring(6, 10)) && Integer.parseInt((jdNgayThi.getText().substring(3, 5))) <= Integer.parseInt(MainAdmin.date.substring(3, 5))) {
                JOptionPane.showMessageDialog(this, "Ngày thi phải lớn hơn 2 tháng và nhỏ hơn 6 tháng tính từ thời điểm hiện tại !", "Kiểm tra lại", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
    ...
    private javax.swing.JTextField jdNgayThi;
