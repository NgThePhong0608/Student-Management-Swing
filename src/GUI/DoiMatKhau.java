    ...
    public void send() {
        ...
        if (pass1.equals(strnull) || pass2.equals(strnull)) {
            ...
            if (pass1.equals(nd.get(0).getMatKhau()) == false) {
                JOptionPane.showMessageDialog(this, "Sai mật khẩu cũ ", " Vui lòng kiểm tra lại",
                        JOptionPane.INFORMATION_MESSAGE);
                txtmatkhaucu.requestFocus();
            } else if (txtmatkhaumoi.getText().length() < 6 && !Check.checkNumber(pass2)) {
                JOptionPane.showMessageDialog(this, "Mật khẩu phải lớn hơn 5 ký tự ", " Vui lòng kiểm tra lại",
                        JOptionPane.INFORMATION_MESSAGE);
                txtmatkhaumoi.requestFocus();
            } else {
