...
public class frmLichHoc extends javax.swing.JFrame {
    ...
    private void loaddata() {
        try {
            ListPhieuDKH = new PhieuDangKyHocDAO().getAll_LHP_ByMaSV(Login.nameLogin);/*
                                                                                       ...
                                                                                       * giáo viên đã đăng ký theo mã GV
                                                                                       */
    ...
    public static Object[] toObjectsData(LopHocPhan lhp)
        ...
        Object[] objectsData = { lhp.getMaLHP(), lhp.getMaHP(), listMH.get(0).getTenMH(), lhp.getTietHoc(),
                lhp.getPhongHoc(), lhp.getThu(), lhp.getHocKy(), lhp.getNamHoc(), lhp.getNgayThi() };
        return objectsData;
    }
    ...
    private void initComponents() {
        ...
        jtbDSLopHocPhan.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Mã Lớp Học Phần", "Mã Học Phần", "Tên Môn Học", "Tiết Học", "Phòng Học", "Thứ", "Học Kỳ",
                        "Năm Học", "Ngày Thi Dự Kiến"
                }) {
        ...
        jPanel5Layout.setVerticalGroup(
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 359,
        ...
        jPanel3Layout.setVerticalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(btnHuy, javax.swing.GroupLayout.PREFERRED_SIZE, 37,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLichHoc.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(frmLichHoc.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
